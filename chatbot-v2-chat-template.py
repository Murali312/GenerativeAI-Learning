    ...
    if person_name and person_role:
        with st.spinner("Searching internal knowledge base for {person_name}"):
            try:
                ...
                # Dynamic Chat Prompt Template : We pass both variables into the template
                prompt = ChatPromptTemplate.from_messages([
                    ("system", '''
                        You are an expert research assistant.
                        Format the response strictly as follows :
                        - Start with a 1-sentence summary of who they are
                        - Provide 5 bullet points of specific achievements in their role
                        - Keep the tone professional and factual
                    ''')
                    ("human", " Identify the top 5 key professional achievements of {name} specifically in their role as {role}. If you don't the answer please say You don't know")
                ])
